...
$dataUsuario = $classUsuarios -> showData("Inactivo");
?>
...
<head>
	...
	<!-- Titulo Pestaña=================== -->
	<title>S.W.C.D/Usuarios inactivos</title>
...
<body class="stretched side-panel-left" data-loader="4" data-loader-color="#999">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-mini">
			...
			<div class="container clearfix">
				<h1><i class="icon-line2-user-unfollow"></i> Usuarios inactivos</h1>
				<!-- Menu=================== -->
				<ol class="breadcrumb">
					<li><a href="index.php">Administrador</a></li>
					<li><a href="usuarios.php">Usuarios</a></li>
					<li>Usuarios inactivos</li>
				</ol>
                <!-- /Menu================== -->
			</div>
		...
		<section id="content">
			...
			<div class="content-wrap-short">
				...
				<div class="container clearfix">
                   ...
                   <div class="col_one_fourthm col_last center"></div>
                    <div class="col_full">
               ...
               <strong> Fecha de modificación:</strong>&nbsp;<br>".  $fm_usuario ."<br>
                            ...
                            <button type='submit' class=' button button-rounded button-reveal button-green tright'><i class='icon-line-check'></i><span>Reactivar</span></button>
                            </form>
                            </td>";
                            echo "</tr>"; ?>
                            <?php } } ?>
