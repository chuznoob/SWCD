...
<head>
	...
	<!-- Titulo Pestaña=================== -->
	<title>S.W.C.D/Menú de documentos/Editar-Eliminar</title>
                   ...
                   <h4><i class="icon-grid"></i> Tabla de elementos</h4>
                    ...
                    <div class="col_full">
						<div class="panel panel-default">
                            ...
                            <form name='F-update' action='form-documentos.php' method='post'>
                            <input type='hidden' name='id' value='".$data->id_documento."'>
                            <input type='hidden' name='nom' value='".$data->nom_documento."'>
                            <input type='hidden'' name='bread' value='editor'>
                            ...
                            echo "<td class='center'>
                            <form name='F-update' action='../lib/ops_documento/disableDocumento.php' method='post'>
                            <input type='hidden' name='id' value='".$data->id_documento."'>
                            <input type='hidden' name='path' value='".$data->path_documento."'>
                            <input type='hidden' name='ext' value='".$data->ext_documento."'>
                            <input type='hidden' name='ver' value='".$data->ver_documento."'>
                            <input type='hidden' name='nom' value='".$data->nom_documento."'>
                            <input type='hidden' name='um' value='".$_SESSION['id_usuario']."'>
