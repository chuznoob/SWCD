		...
		<section id="content">
			...
			<div class="content-wrap-short">
				...
				<div class="container clearfix">
                   ...
                   <a href="form-noticias.php" class="button button-rounded button-reveal button-teal button-border tright"><i class="icon-plus-sign2"></i><span>Agregar Noticia</span></a></div>
                    ...
                    <div class="col_full">
						<div class="panel panel-default">
                            ...
                            <?php
                            if($dataNoticia != NULL){
                            while($data=$dataNoticia->fetchObject()){
                                
                                if($data->uc_noticia==NULL){
                                    $uc_noticia="Sistema";
                                }else{
                                $idc=$data->uc_noticia;
                                ...
                                $um_noticia=$dataU2->nom_usuario;
                                 ...
                                 if($data->fm_noticia==NULL){
                                    $fm_noticia="Sin Modificaciones";
                                }else{
                                    $fecha = DateTime::createFromFormat('Y-m-d H:i:s', $data->fm_noticia);
                                    $ts= $fecha->getTimestamp();
                                    $fm_noticia=strftime("%d %B del %Y <br> %I:%M:%S %p",$ts);
                                }
                                
                            echo "<tr class='odd gradeX'>";
                            echo "<td>" . $data->tit_noticia . "</td>";
                            echo "<td class='col-md-4'>" . $data->cont_noticia . "</td>";
                            echo "<td>" . $data->prior_noticia . "</td>";
                            echo "<td><Strong>Creador:</Strong><br>" . $uc_noticia . "<br>
                                      <Strong>Fecha:</Strong><br>" . $fc_noticia . "</td>";
                            echo "<td><Strong>Modificador:</Strong><br>" .$um_noticia . "<br>
                                      <Strong>Fecha:</Strong><br>" . $fm_noticia . "</td>";
                            echo "<td class='center'>
                            <form name='F-update' action='form-noticias.php' method='post'>
                            <input type='hidden' name='id' value='".$data->id_noticia."'>
                            <input type='hidden' name='nom' value='".$data->tit_noticia."'>
                            ...
                            echo "<td class='center'>
                            <form name='F-update' action='../lib/ops_noticia/deleteNoticia.php' method='post'>
                            <input type='hidden' name='id' value='".$data->id_noticia."'>
                            <input type='hidden' name='nom' value='".$data->tit_noticia."'>
    ...
    <script>
        $(document).ready(function() {
            $('#dataTables-example2').dataTable( {
                ...
                "oLanguage": {
                    "sLengthMenu": " _MENU_ Noticias por p&aacute;gina"
                }
            } );
