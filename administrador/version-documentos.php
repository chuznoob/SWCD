...
<head>
	...
	<!-- Titulo Pestaña=================== -->
	<title>S.W.C.D/Menú de documentos/Nueva-Versión</title>
                   ...
                   <h4><i class="icon-grid"></i> Tabla de elementos</h4>
                    ...
                    <div class="col_full">
						<div class="panel panel-default">
                            ...
                            <input type='hidden'' name='bread' value='version'>
                            <button type='submit' class=' button button-rounded button-reveal button-blue tright'><i class='icon-line-outbox'></i><span>Subir versión</span></button>
                            </form>
                            </td>";
                            } } ?>
