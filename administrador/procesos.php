...
$classProc = new Proceso();
$dataProc = $classProc -> showData();
?>
		...
		<section id="content">
			...
			<div class="content-wrap-short">
				...
				<div class="container clearfix">
                   ...
                   <a href="form-procesos.php" class="button button-rounded button-reveal button-teal button-border tright"><i class="icon-plus-sign2"></i><span>Agregar Proceso</span></a></div>
                    ...
                    <div class="col_full">
						<div class="panel panel-default">
                            ...
                            <form name='F-update' action='form-procesos.php' method='post'>
                            <input type='hidden' name='id' value='".$data->id_proceso."'>
                            <input type='hidden' name='nom' value='".$data->nom_proceso."'>
                            ...
                            echo "<td class='center'>
                            <form name='F-update' action='../lib/ops_proceso/deleteProceso.php' method='post'>
                            <input type='hidden' name='id' value='".$data->id_proceso."'>
                            <input type='hidden' name='nom' value='".$data->nom_proceso."'>
...
<?php unset($_SESSION['errorOp']); unset($_SESSION['detOp']); }else{ 
 ...
 <div id="mensaje" data-notify-position="top-right" 
     data-notify-type="error" 
     data-notify-msg="<i class='icon-remove'></i> La operación de <strong><?php echo $_SESSION['detOp']; ?></strong> no se completó, por favor verifica si el proceso no está siendo usado por un usuario , ya que no es posible borrar un proceso que está siendo usado"></div>
