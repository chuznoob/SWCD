...
$classSpa = new Spa();
$dataSpa = $classSpa -> showDataAre($id_area); 
?>
...
<head>
	...
	<!-- Titulo Pestaña=================== -->
	<title>S.W.C.D/Relaciones de Área</title>
		...
		<section id="content">
			...
			<div class="content-wrap-short">
				...
				<div class="container clearfix">
                   ...
                   <i class="icon-grid"></i> Tabla de subdirecciones relacionadas al área "<?php echo $nom_area; ?>"</h4></div>
                   <div class="col_one_fourth col_last center">
                   <form name='F-update' action='form-rel-area.php' method='post'>
                    <input type='hidden' name='ida_spa' value='<?php echo $id_area; ?>'>
                    <input type='hidden' name='nom_area' value='<?php echo $nom_area; ?>'>
                    ...
                    <div class="col_full">
						<div class="panel panel-default">
                            ...
                            $dataSubdireccion = $classSubdireccion -> showData($ids);
                             ...
                             if($dataSubdireccion!=NULL){ 
                             while($data=$dataSubdireccion->fetchObject()){   
                                ...
                                if($data->fc_subdireccion==NULL){
                                    ...
                                    $fc_subdireccion=strftime("%d %B del %Y &nbsp;|&nbsp; %I:%M:%S %p",$ts);
                                }
                                ...
                                $um_subdireccion=$dataU2->nom_usuario;
                                 ...
                                 if($data->fm_subdireccion==NULL){
                                    ...
                                    $ts= $fecha->getTimestamp();
                                    $fm_subdireccion=strftime("%d %B del %Y &nbsp;|&nbsp; %I:%M:%S %p",$ts);
                                }
                            ...
                            <form name='F-update' action='../lib/ops_spa/deleteSpa.php' method='post'>
                            <input type='hidden' name='id' value='".$id."'>
                            <input type='hidden' name='noms' value='".$data->nom_subdireccion."'>
                            <input type='hidden' name='noma' value='".$nom_area."'>
